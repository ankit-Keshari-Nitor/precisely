...
export default function ApiDefineForm({ id, setOpenCancelDialog, onSubmitDefinitionForm }) {
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  return (
    <>
      <Form aria-label="api-define-Form" name="api-define-Form" data-testid={id} onSubmit={handleSubmit(onSubmitDefinitionForm)}>
