...
export default function CustomDefineForm({ id, setOpenCancelDialog, onSubmitDefinitionForm }) {
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  return (
    <>
      <Form aria-label="custom-define-Form" name="custom-define-Form" data-testid={id} onSubmit={handleSubmit(onSubmitDefinitionForm)}>
